...
# =========================================================
# GPU 0 shard for full SISR grid search
# Run together with run_sisr_grid_gpu1.sh
# IMAGE_START=1 IMAGE_END=1 FAIL_FAST=1 bash run_sisr_grid_gpu0.sh
# =========================================================
...
# LR defaults. Change from environment if needed, e.g. ADAM_LR=3e-4 bash run_sisr_grid_gpu0.sh
...
#   LRSIGN10_OPT=lr-sign10-rsclF bash run_sisr_grid_gpu0.sh
